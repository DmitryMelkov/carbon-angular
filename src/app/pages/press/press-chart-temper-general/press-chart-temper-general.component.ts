...
@Component({
  selector: 'app-press-chart-temper-general',
  standalone: true,
  imports: [ControlButtonComponent, UniversalGraphComponent],
  templateUrl: './press-chart-temper-general.component.html',
  styleUrl: './press-chart-temper-general.component.scss'
})
export class PressChartTemperGeneralComponent {
